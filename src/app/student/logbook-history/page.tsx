                ...
                <header className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex items-center gap-4">
                        <button
                            ...
                            className="px-4 py-2 border border-blue-200 dark:border-blue-900/50 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-800 transition-all font-bold shadow-sm"
                        >
                            Back to Logbook
                        </button>
