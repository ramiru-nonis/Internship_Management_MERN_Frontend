        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-8">
            <div className="max-w-4xl mx-auto">
                ...
                {existingMarksheet?.finalGradingStatus === 'Completed' && (
                    <div className="bg-gradient-to-r from-green-600 to-emerald-700 rounded-2xl p-8 mb-8 text-white shadow-xl relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10 mt-6">
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                                <p className="text-xs font-bold uppercase tracking-wider opacity-80 mb-1">Academic Score</p>
                                <p className="text-3xl font-bold">{existingMarksheet.marks?.total || 0}<span className="text-sm opacity-60">/60</span></p>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                                <p className="text-xs font-bold uppercase tracking-wider opacity-80 mb-1">Industry Score</p>
                                <p className="text-3xl font-bold">{existingMarksheet.industryMarks || 0}<span className="text-sm opacity-60">/40</span></p>
                            </div>
                            <div className="bg-white text-green-700 rounded-xl p-4 shadow-lg transform scale-105">
                                <p className="text-xs font-bold uppercase tracking-wider mb-1 opacity-70">Final Total</p>
